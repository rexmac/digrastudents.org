<?php
namespace Rexmac\Zend\Session\SaveHandler;

use Rexmac\Zend\Session\Service\SessionService,
    \Zend_Config,
    \Zend_Registry,
    \Zend_Session,
...
class DoctrineSaveHandler implements \Zend_Session_SaveHandler_Interface {
   ...
   * @var string
   */
  private $entityClass = 'Rexmac\Zend\Session\Entity\Session';
   ...
   * @return DoctrineSaveHandler Provides fluent interface
   */
