        ...
        return this.each(function (index, elem) {
            ...
            function _fnCreateGroup2Row(sGroup2, sGroupLabel, iColspan, oParentGroup) {
                ...
                if (properties.bExpandableGrouping && properties.bExpandableGrouping2) {
                    ...
                    //Roberto Armenio - Two-level grouping optimization
                    $(nGroup2).hide();
                }
            ...
            function fnCollapseGroup(sGroup) {
                ...
                //Roberto Armenio - End of Two level grouping optimization

                $("td[data-group^='" + sGroup + "']").removeClass("expanded-group").addClass("collapsed-group");
                ...
                if (properties.oHideEffect != null) {
                    $(".group-item-" + sGroup, oTable)
                      [properties.oHideEffect.method](properties.oHideEffect.duration, properties.oHideEffect.easing, function () { });
                    //Roberto Armenio - Two-level grouping optimization
                    $("tr[class*='group-item-" + sGroup + "']", oTable)
                      [properties.oHideEffect.method](properties.oHideEffect.duration, properties.oHideEffect.easing, function () { });
                } else {
                ...
                if (oSettings.aiDisplay.length > 0) {
                    for (var i = 0; i < nTrs.length; i++) {
                        ...
                        if (bUseSecondaryGrouping) {
                            ...
                            //Roberto Armenio - Two-level grouping optimization
                            $(nTrs[i]).removeClass("group-item-" + sGroupCleaned);
